...
/**
 * Ethan Petuchowski 11/21/2015
 *
 * Modified from the JavaDoc for org.eclipse.jetty.http2.client.HTTP2Client
 */// TODO NOT WORKING
public class JettyClientExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        MetaData.Request request = new MetaData.Request(
            "GET",
            new HttpURI("https://" + host + ":" + port + "/index.html"),
            HttpVersion.HTTP_2,
            requestFields
        );
        ...
        Stream.Listener responseListener = new Stream.Listener.Adapter()
        {
            ...
            public void onData(Stream stream, DataFrame frame, Callback callback)
            {
                ...
                int duration = (int) TimeUnit.NANOSECONDS.toSeconds(elapsedNanos);
